...
def get_dataloader(
    ...
    if dali:
        return dali_data_iter(
            ...
            num_threads=2, local_rank=0, dali_aug=dali_aug)
    ...
    train_loader = DataLoader(
        ...
        pin_memory=True,
        drop_last=True,
        worker_init_fn=partial(worker_init_fn, num_workers=num_workers, rank=0, seed=seed) if seed is not None else None,
    )
